...
description: |-
  Crystal skill compiled from finance-bp-080 (macro-data on global). Triggers: training, knowledge graph, dynamic graph, early stopping, overfitting prevention, evaluation, metrics.
